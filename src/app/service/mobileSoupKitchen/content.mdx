...
<br />
When a client reaches the front of the line, they open their bag and receive at least one of each item (unless the item has run out or they decline it). Depending on supply levels and the situation, they may receive more, which is explained later. Once everyone in line has been served, volunteers wait an extra two or three minutes in case anyone arrives late. After this brief buffer, everyone piles back into the van and they move on to the next stop.{" "}
